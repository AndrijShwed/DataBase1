    ...
    public partial class Реєстрація : Form
    {
        ...
        private bool IsUser
        {
            get
            {
                ...
                string loginUser = textBoxLogin.Text.ToString().Replace("'", "`");
                string nameUser = textBoxName.Text.ToString().Replace("'", "`");
                string surnameUser = textBoxSurname.Text.ToString().Replace("'", "`");
        ...
        private void buttonRegistration_Click(object sender, EventArgs e)
        {
            ...
            if(!IsUser)
            {
                if(!IsLogin)
                {
                    ...
                    try
                    {
                        _mySqlCommand.Parameters.Add("@name", MySqlDbType.VarChar).Value = textBoxName.Text.ToString().Replace("'", "`");
                        _mySqlCommand.Parameters.Add("@surname", MySqlDbType.VarChar).Value = textBoxSurname.Text.ToString().Replace("'", "`");
                        _mySqlCommand.Parameters.Add("@login", MySqlDbType.VarChar).Value = textBoxLogin.Text.ToString().Replace("'", "`");
